...
def plot_neuron_rates(r, exc_ind, inh_ind, stim_on, stim_dur, delay, sort=1):
    ...
    axs[0].set_xticklabels((np.arange(0,3000,3000/6)).astype(int), fontsize=12)
    axs[0].set_ylabel('Neurons', fontsize=12)
    axs[0].set_title('Excitatory neurons', fontsize=14)
    ...
    axs[1].set_xlabel('Time from trial start (ms)', fontsize=12)
    axs[1].set_xticks([0, 100, 200, 300, 400, 500])
    axs[1].set_xticklabels((np.arange(0,3000,3000/6)).astype(int), fontsize=12)
    axs[1].set_ylabel('Neurons', fontsize=12)
    axs[1].set_title('Inhibitory neurons', fontsize=14)
