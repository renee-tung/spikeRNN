...
for n_type = 1:length(models_types) % good and bad models
    ...
    figure; hold on;
    plot(o_array(label_array == 1,:)', 'Color', [1,0,0,0.5])
    plot(o_array(label_array == 0,:)', 'Color', [0,0,1,0.5])
    xline(stim1_onset, 'Color','k','LineWidth',2)
    xline(stim1_offset, 'Color','k','LineWidth',2)
