%% Calculate stable_perfs for each model

% for the letters task, try extending the delay period and evaluating the models
% extend delay from 10 (training) to 50 (eval)
